...
async function exportVideo() {
  ...
  ticker.onTick = () => {
    ...
    /* ---- Упреждение: кадр рисуем не «на сейчас», а на то мгновение,
       ...
       картинка отставала от звука на 10–45 мс, и тем сильнее, чем выше
       качество. Причин две, и обе складываются.

       Первая: кадр, нарисованный в такт T, висит в ролике до следующего
       такта, то есть показывает песню в среднем на полкадра позже, чем
       она есть. Вторая: пока кадр рисуется (а на 1440p это заметное
       время), мгновение уже ушло — а метку кадру ставят по концу
       отрисовки, не по началу.

       Обе лечатся одним: считаем время НА СЕРЕДИНУ будущего кадра
       и добавляем цену прошлой отрисовки. Поправка своя на каждой машине
       и на каждом качестве — потому и меряется на ходу, а не вписана
       числом. На управление она не влияет: остановка и полоса хода

...
contextBridge.exposeInMainWorld('desktop', {
  ...
  /* Вернуть клавиатуру странице. На Windows окно бывает «в фокусе»,
     а страница внутри него — нет: мышь работает, текст выделяется,
     а буквы не доходят. Само по себе это чинится на возвращении окна,
  ...
  singStart: (о) => ipcRenderer.invoke('sing-start', о),
  singStop: () => ipcRenderer.invoke('sing-stop'),
  singState: () => ipcRenderer.invoke('sing-state'),

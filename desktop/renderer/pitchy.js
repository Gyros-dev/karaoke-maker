/* ============================================================
   pitchy 4.1.0 — Ian Johnson, MIT. Взято с npm, файл index.js.
   Определение высоты звука методом Маклауда (MPM).

   ЧТО ИЗМЕНЕНО: адрес импорта БПФ — «fft.js» заменён на
   «./fft-indutny.js». Голое имя пакета браузер разрешить не умеет,
   а сборщика у нас нет. Больше не тронуто ничего.
   ============================================================ */

import FFT from './fft-indutny.js';

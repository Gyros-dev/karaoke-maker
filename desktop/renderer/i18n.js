...
I18N.EN = {
  ...
  'новости.какВМонтажной': '<b>The studio got quieter.</b> Parameters are always on the right — in the editor and on “Karaoke” alike. The timeline runs the full width of the window, the time ruler is set apart from the tracks, and the workplace is steel grey by default: only the selection carries colour. The old green theme is one click away on the theme icon.',

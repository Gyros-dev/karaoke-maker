...
I18N.EN = {
  ...
  'ред.клавиши': '<kbd>space</kbd> play · <kbd>↑</kbd><kbd>↓</kbd> line · <kbd>←</kbd><kbd>→</kbd> start · <kbd>[</kbd><kbd>]</kbd> end · <kbd>I</kbd><kbd>O</kbd> start and end at the playhead · <kbd>,</kbd><kbd>.</kbd> nudge a frame, with <kbd>Shift</kbd> ten · <kbd>Shift</kbd> finer, <kbd>Alt</kbd> coarser · <kbd>Enter</kbd> listen · <kbd>L</kbd> loop · <kbd>S</kbd> snapping · <kbd>G</kbd> beat grid · <kbd>Delete</kbd> remove a stretch · <kbd><span class="mod-key">Cmd</span>+Z</kbd> undo · word joint: a plain drag makes a pause, with <kbd><span class="mod-key">Cmd</span></kbd> both edges move · wheel scrolls, with <kbd><span class="mod-key">Cmd</span></kbd> zooms',

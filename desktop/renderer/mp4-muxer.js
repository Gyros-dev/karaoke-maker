/* ============================================================
   mp4-muxer 5.2.2 — Vanilagy (Julian Bartels), MIT. Взято с npm,
   файл build/mp4-muxer.js (сборка для браузера: заводит глобаль).
   Складывает сжатые кадры H.264 и звук AAC в файл MP4.

...
I18N.ПОХВАЛЫ = {
  ru: [
    ...
    'Браво! Спасибо, что спел — было отлично!',
    'Спасибо за песню! Ты был великолепен!',
    'Браво! Спасибо за этот вокал!',
    'Спасибо за выступление! Ну ты выдал! Респект',
    'Браво! Спасибо, что устроил такой концерт!',
    'Спасибо за голос! Браво — это было мощно!',
    'Браво! Спасибо за песню. Получилось! \u{1F44F}\u{1F3A4}',
    'Спасибо за выступление! Это было сильно. Браво!',
    'Браво! Спасибо, что спел от души!',
    'Спасибо за этот момент! Браво!',
  ],
  en: [
    ...
    'Bravo! Thanks for singing — that was great!',
    'Thanks for the song! You were magnificent!',
    'Bravo! Thank you for that voice!',
    'Thanks for the show! You nailed it. Respect',
    'Bravo! Thank you for that concert!',
    'Thank you for the voice! Bravo — that was powerful!',
    'Bravo! Thanks for the song. That landed! \u{1F44F}\u{1F3A4}',
    'Thanks for the show! That was strong. Bravo!',
    'Bravo! Thank you for singing from the heart!',
    'Thank you for that moment! Bravo!',
  ],
};
...
I18N.EN = {
  ...
  'новости.окноСборки': '<b>The building window no longer twitches.</b> The progress line kept fitting and not fitting on one line, and the whole window jumped several times a second.',
  'новости.главное': 'The main things',
  'новости.главное.ролик': '<b>🎬 The clip is built, not recorded.</b> The highlight in the finished video stays level with the sound on any machine, building is three times faster than recording, and the file is written straight to disk — no breaking off near the end on machines with modest memory.',
  'новости.главное.отсчёт': '<b>⏱ A count-in before you sing.</b> The dots fade out before the first line, and if the voice comes in on the very first second the studio adds the time itself so the count-in fits.',
  'новости.главное.очередь': '<b>📋 A queue of several songs.</b> Pick the songs and the lyrics, say where to put the results — the studio removes the vocals, lays the lyrics out in time and saves the finished projects itself.',
  ...
  'новости.ценаРолика': '<b>The “Save video” window tells the truth.</b> The length of the clip, the size of the file and an honest “building is faster than the song plays”. The old line promised recording in real time — that was how it worked before 1.31.0.',
  'новости.отменаЗаписи': '<b>Cancelling a save no longer freezes the studio.</b> The “Mixing the sound…” window could stay on screen forever, and the next “Save” quietly refused to start.',
  'новости.времяСтроки': '<b>A line has one time everywhere.</b> In the list, in “Parameters”, in the .lrc and in the clip — the same number: the one the line lights up at.',
  'новости.хвостТекста': '<b>Extra lines no longer run past the end of the song.</b> If there is more text than singing, the last lines are pinned to the end, flagged with “≈” — and the studio says plainly how many lines the song had no room for.',
  'новости.узкоеОкно': '<b>Nothing overlaps in a narrow window.</b> The top row is laid out in three columns, and the step chips now let you move forward by the work: there is text — the “Editor” is open; there are timings — “Karaoke” is open.',
  'новости.картинкаБроском': '<b>The background picture can be dropped in.</b> Onto the “Karaoke background” card or straight onto the stage. A ready instrumental the same way, onto its own card.',
  'новости.мелочиРедактора': '<b>Small things in the editor.</b> The buttons in “Parameters” no longer swap places, a short line on the timeline has a caption, “+” keeps the selected line in view, and the “What’s new” link follows the theme.',
  'новости.файлыСами': '<b>The app writes files itself.</b> It asks where to put them with its own dialog and leaves no hidden leftovers in Downloads. And the result of “Remove vocals” now sits on its own card instead of the neighbouring one.',
  ...
  'новости.однаФорма': '<b>One shape for buttons and windows.</b> There used to be three: pill-shaped buttons, a round play button and rectangular windows. Now there is one family — rectangles with rounded corners, like in an editing program. And the whole top row is one height.',
  'новости.журнал': '<b>A log: somewhere to look when “it does not work”.</b> The studio writes the launch, the notable steps and every error into a file next to its own settings. It is never sent anywhere; the button at the bottom of the guide shows it.',
  'новости.пробелТранспорт': '<b>Space in the editor is always play/pause.</b> After you clicked a button the focus stayed on it, and space pressed it again: pause the song, turn on the magnet — and space toggles the magnet instead of playing. Space is now given to nothing but text fields; buttons are pressed with Enter.',
  'новости.словоПоВидимому': '<b>A word is dragged at the size you see.</b> The last word of a line is shown together with its melisma tail, while dragging took the width from the timing data — so the block collapsed into a sliver the moment you moved it. And the other one: on a line pulled to the vocal onset a word edge landed away from the mouse — by 0.22 s in the measurement. Dragging, edges, keys and fields now all speak the same time: the one on the timeline.',
  'новости.укоротилСтроку': '<b>Shorten a line and the words no longer all shrink at once.</b> They used to be squeezed by a common factor, keeping the proportions of a wrong layout, and the line had to be laid out again. Now the words that fit stay exactly where they were, and those left outside the end are laid out in what remains; put the end back and the timing comes back with it.',
  'новости.настройкиСтроки': '<b>The line settings no longer disappear.</b> The “Word” and “Line” sections of the parameters panel kept closing each other on every redraw, and a click on a line block left nothing but a collapsed heading. A section now opens for what you selected and stops arguing with what you opened by hand.',
  'новости.отпечатокМодели': '<b>The downloaded separation model is checked by fingerprint.</b> Only the file length used to be verified — and neighbouring models of the same family match it to the byte.',
  'новости.подгонкаТочнее': '<b>The neural net places timings more accurately.</b> Measured against a song timed by hand: the median error was five seconds, now it is one. A single misheard word no longer decides for the whole line, free words land on actual singing instead of splitting an instrumental break evenly, and a line is no longer torn apart by silence.',
  'новости.очиститьПроект': '<b>A project can be cleared.</b> Loaded the same song but want a clean slate? “Clear the project” in the menu by the song name. The lyrics, the timings, the word timing, the stretches, the background and the key all go; the song and the instrumental stay.',
  'новости.имяВидео': '<b>The exported video carries the studio’s name.</b> It used to be “Song (karaoke).webm”, now it is “Song (karaoke punch).webm”.',
  'новости.дорожкаТочнее': '<b>The timeline follows your aim.</b> Of two edges side by side you get the one you aimed at, not the first one found. And a word squeezed down to a ten-pixel sliver can be grabbed and moved again: the whole sliver is a move handle.',
  'новости.подсветкаОдна': '<b>The highlighting is the same everywhere.</b> The editor preview, the “Karaoke” stage and the exported video now show the same thing: the notes of an instrumental break used to be filled differently in each.',
  'новости.знакПоМонтажному': '<b>The studio’s mark in the frame is put together properly.</b> The name used to sit on its own line above the picture, right at the edge and at a different opacity. Now it is one lockup on a single line — picture and name on a shared centre line, in the bottom-right corner, inside the frame’s safe area and half the size it was.',
  'новости.паузаМеждуСтроками': '<b>A pause between lines is now made by dragging.</b> The joint between two lines behaved unlike the joint between words: drag right and the boundary went left, so the pause always came out as small as it gets. They match now: a plain drag pulls the joint apart, Cmd/Ctrl moves both boundaries together.',
  'новости.правкаДвойным': '<b>A line’s text is edited with a double-click.</b> A single click on the text used to put the caret in the field — and the editor stopped hearing every key, undo included. Now the first click only selects the line, and editing opens with a double-click or the <b>F2</b> key; Enter and Esc end it.',
  'новости.видеоДлина': '<b>Exported video now has a duration.</b> Players treated the clip as a live stream: the time bar was useless, there was no seeking, and some services refused the file.',
  'новости.битыйФайлПочинен': '<b>An unreadable file no longer wipes your timing.</b> Agreeing to another song erased the work before the new song had even been read: the file failed to open, and the timing was already gone.',
  'новости.полямПравда': '<b>The time fields and the song card tell the truth.</b> A line’s start no longer goes past its own end, typed nonsense no longer sits where the value should be, a long line in the list no longer overlaps its neighbours, and the sample rate is gone: it showed the sound card’s rate, not the file’s.',
  'новости.мелочиУгловые': '<b>Little things that got in the way.</b> An instrumental shorter than the song warns you at once, not at the sound check. The “,” and “.” keys move a selected stretch as a whole. The “tap again” button is dimmed when there are no lines. “Instrumental .wav” with no song names the real reason. In the “What’s new” window the “Got it” button stays in view, and the “Quality” row no longer sticks out of its card.',
  ...
  'новости.кружокВозвращается': '<b>Double-clicking a slider brings the knob back too.</b> The value returned, but the knob stayed where it was.',
  'новости.руководствоПравда': '<b>The guide describes the rules as they are now.</b> The word joint was described the other way round, and snapping was explained twice in a row.',
  'новости.фейдОригинала': '<b>Original-audio stretches now have edges.</b> The original used to come in over fifty milliseconds — after a quiet instrumental that reads as “barely audible, then very loud”. Now every stretch has its own fade in and fade out, up to five seconds: two sliders in the “Original” panel and slopes on the block in the timeline. It goes into the .wav instrumental and into the video as well.',
  'новости.паузаПротяжкой': '<b>A pause between words is now a plain drag.</b> A plain drag used to move the whole joint, and only Cmd/Ctrl could pull the edges apart — with nowhere to learn that from. It is the other way round now: drag the joint and you get a pause, while Cmd/Ctrl moves both edges together.',
  'новости.клавишиМонтажа': '<b>The I, O, “,” and “.” keys.</b> I and O set the start and the end right at the playhead — get there by ear and press a key, instead of aiming the mouse at a pixel. “,” and “.” move the whole selection by one frame, ten with Shift. With a word selected they edit the word, not the line.',
  'новости.чипПроекта': '<b>You can see where the work lives.</b> The chip on the left names the open project, and a dot beside it means there are changes that aren’t in the folder yet. Click the chip and everything you can do is there: save, save as, open another one, show the folder. And the first step lists your recent projects.',
  'новости.фонВРедакторе': '<b>The background shows in the editor too.</b> Only the “Karaoke” stage used to show the picture: you timed the lyrics against a plain ground and then saw a different scene — bright places where the text disappears. Now you can judge readability where you edit.',
  'новости.какВМонтажной': '<b>The studio got roomier.</b> Parameters are always on the right — in the editor and on “Karaoke” alike. The timeline runs the full width of the window, the time ruler is set apart from the tracks, and the bars between panes are gone altogether: the panes sit flush, and a border only shows up under the cursor, where you can drag it.',
  'новости.ползункиСброс': '<b>Double-clicking any slider brings back its default.</b> Three sliders out of twenty could do that — now all of them can: size and colours, the equaliser, track levels, vocals and the edges of an original stretch.',
  'новости.похвалыБезПанча': '<b>The praise after a song no longer name-drops the studio.</b> Eight phrases called you “a real Punch” and praised your “vocal punch” — you sang a song and got congratulated with the name of a program.',
  'новости.окнаВпритык': '<b>The bars between panes are gone; the panes sit flush.</b> Just like Final Cut: dragging a border is as easy as before — the grab zone is wider than the line itself — and the preview gained thirty-five points of width. The help icon, which sat crooked, is straight now.',
  'новости.наборДоведён': '<b>Typing after timing is now fully sorted.</b> Last release taught system windows to hand the keyboard back, but on Windows that was not enough: the page still counted itself as “not focused”, and the browser refused to insert letters — while deleting still worked. The studio now notices that disagreement and asks the window to rebuild the focus for real.',
  'новости.позжеНеНикогда': '<b>“Later” no longer means “never”.</b> One click on that button used to hide the new-version notice forever — and people stayed on an old studio without knowing it. The reminder now comes back on the next launch, and if three or more releases have been missed, the bar says how many and does not offer “Later” at all.',
  'новости.окноНовостей': '<b>This window now leads with what is new.</b> Fixes, even big ones, go under the triangle: people open it asking “what’s new”, not “what did you patch”.',
  'новости.окнаКлавиатура': '<b>You can type again after timing the lyrics.</b> On Windows it could happen that once the network had placed the times and shown its summary, nothing could be typed any more — not in the lyrics box, not in the editor. The mouse worked, text selected, letters went nowhere. The summary message itself turned out to be the culprit: a system window took the keyboard as it closed and never handed it back to the page. Every system window — a message, a question, a folder picker — now returns the keyboard when it closes.',
  'новости.витринаНеМелькает': '<b>A slice of the website no longer flashes at startup.</b> For a second after opening you could see the “Desktop version” section — the one offering to download the app you already have. A script was hiding it, and that script is the last one on the page: until it ran, the section sat honestly between the header and the studio. Styles now put it out — with the very first frame, before any script.',
  'новости.окноГотовым': '<b>The app opens ready-made.</b> The window used to appear at once, before the page had loaded — so the first frames were whatever happened to be drawn. On a fast machine you would never notice; on Windows you could: for a second something resembling the website flashed, and only then came the studio. The window now waits until the page has something to show, and appears already put together.',
  'новости.хвостРазметки': '<b>\u{1F3AF} Timing no longer crushes the end of the song.</b> It used to happen that the network heard a word of its own past the end of the song — and the studio dutifully spread every remaining line across whatever gap was left. Lines came out seven hundredths of a second long, glued together at the very edge and invisible: zoom in and they are gone, scroll and they are gone, and only “whole song” would find them. The end of the recording is now an anchor like any word: the studio refuses to lay twenty lines into a quarter of a second, and after timing it shows the whole song by itself, so you can see everything it brought. On a real song the shortest line became 0.81 s instead of 0.07.',
  'новости.вкладкаРедактор': '<b>The “Editor” tab no longer opens onto nothing.</b> The first time you went through the top tab the editor came up empty, and only the “To the editor” button at the bottom showed the lines. Both doors now lead into the same room.',
  'новости.просмотрНеСхлопывается': '<b>The “Preview” pane no longer collapses into a strip.</b> Stretch the line list, then widen the parameters panel, and the preview was left with fifty points against its own minimum of 260. Three panes share the width, and only one of them was being recomputed.',
  'новости.цветНаНоутбуке': '<b>The “Colour” tab fits on a laptop.</b> On a 1280×800 screen it was a dozen points short and the settings column scrolled. The explanations under two sliders moved into the labels’ tooltips — they are read once, and they took up room always.',
  'новости.ошибкиПоЧеловечески': '<b>Save errors speak your language and stop guessing.</b> Three messages always came in Russian, even in an English studio. And the message about a folder that cannot be written to insisted it “belongs to another user” — while it can just as well be a matter of permissions on your own folder. It now says only what is actually known.',
  'новости.финалВВидео': '<b>\u{1F3AC} The finale now lives only in the finished video.</b> After a song the studio used to put a window over the stage — the wordmark, the logo, the praise and the score — and you had to close it to get back to work. Karaoke is what is on the stage; the celebration with logos belongs in the file other people will see, next to the watermark. In the video it is all still there, and steadier: the logo no longer jumps before the score, it simply dims, the praise always fits one line, and the percent sign sits tight against the number.',
  'новости.клавиатураВернулась': '<b>Lyrics are editable again after timing.</b> On Windows it could happen that once the network had placed the times, nothing could be typed — neither in the lyrics box nor in the editor. The mouse worked, text selected, and letters went nowhere: the focus stayed with the window without reaching the page, and since the window never left, nothing brought it back. The studio now asks for the keyboard itself — when a long job’s window closes, and on every step change.',
  'новости.чужаяПапка': '<b>A plain answer when a folder cannot be written to.</b> A project saved from Windows into a shared folder belongs to another user on the Mac, and the studio failed with “EACCES: permission denied” and a long path. It now says in words that the folder belongs to someone else, and what to do: pick another place or delete it.',
  'новости.свет': '<b>The glow on the site no longer smears.</b> Hovering a button left a dark rectangle where the glow was — that was the browser repainting a full-screen blur. We draw it differently now; it looks the same. The header menu also sits exactly in the middle.',
  'новости.панельНаУмолчаниях': '<b>The parameters panel fits on untouched settings too.</b> We started running the checks on a clean profile, and it immediately showed that with the default height split the “Line” section is thirteen points short. We squeezed the air between the rows and inside the buttons.',
  ...
  'новости.раньше': 'Everything that changed, release by release',
  ...
  'как.редактор.окна': '<b>Panes.</b> The list of lines is on the left. Double-clicking the text itself opens it for editing (so does the <b>F2</b> key; Enter or Esc ends it), while a double-click anywhere else in the row jumps the song to that line. The preview is in the middle, the parameters on the right: line, word and original stretch, each in its own section. Below them the toolbar and the timeline, the full width of the window. The borders between panes, and between the panes and the timeline, can be dragged — the line shows up when you bring the cursor to it.',
  'как.редактор.полосы': '<b>Timeline tracks.</b> To the left of each one: its name, a level slider and an <b>S</b> button that leaves that track alone in your headphones. Double-clicking any slider in the studio brings back its default.',
  'как.редактор.дорожка': '<b>Timeline.</b> Lines and words are drawn as blocks — you see length, not just a start point. Drag a block’s edge to move a boundary, its middle to move the whole block. The joint between two words comes apart into a pause on a plain drag, and with <span class="mod-key">Cmd</span> held both edges move together without parting. The first word’s left edge is the pause before the singer comes in. The last word’s right edge stretches to the end of the line by itself (that is the melisma) until you set it by hand. Arrow keys nudge the start of the selected line, square brackets its end: a little, and with Alt held, a lot. <b>I</b> and <b>O</b> set the start and the end right at the playhead, and <b>,</b> and <b>.</b> move the whole selection by one frame (ten with Shift). With a word selected the same keys edit the word, not the line. <span class="mod-key">Cmd</span>+Z undoes, <span class="mod-key">Cmd</span>+Shift+Z redoes. The loop button plays the selected line round and round — the fastest way to tell whether the timing lands.',
  'как.редактор.магнит': '<b>Snapping.</b> While you drag an edge it sticks to neighbouring lines and words, to the playhead, to the edges of original-audio stretches, to vocal onsets and endings and to the edges of the song. A coloured guide appears where it sticks — the colour says what it caught. The threshold is the same at any zoom. Holding <b>Alt</b> suspends it for that drag, the <b>S</b> key turns it off for good — same as Logic Pro and Final Cut. <span class="only-desktop">In the app a vocal envelope is drawn on the timeline as well: you can see where the singing actually is.</span>',
  'как.редактор.отрезки': '<b>Original-audio stretches.</b> Sometimes the opening should stay as it is — someone is talking, or another voice is singing. Drag across the stretch track: inside a stretch the original plays instead of the instrumental, the edges can be pulled, and a stretch is removed with the cross, a double-click or the <b>Delete</b> key. Every stretch has its own level, fade in and fade out, so the original doesn’t burst in after a quiet instrumental. In the editor itself you won’t hear the difference — the original plays everywhere here, or there would be nothing to time against; to hear the stretches, clear “hear the original” in the parameters or go to karaoke. Works the same in karaoke, in the exported instrumental and in the video — wherever the “Vocals” slider sits.',
  ...
  'очередь.кнопка.подсказка': 'Several songs in a row: the studio makes the instrumentals and times the lyrics, and puts the finished projects into the folder you choose',
  'очередь.подсказка': 'Instrumentals and timing for several songs in a row, while you get on with something else.',
  'очередь.оЧём': '<b>What will happen.</b> The studio takes the songs one at a time: it removes the vocals from each with the neural network, and if a lyrics file lies beside it, lays the words out in time as well. The finished projects go into the folder you choose — all that is left is to open them. Each song takes a few minutes; you can walk away and stop it at any moment.',
  'очередь.шаг1.заголовок': 'Step 1 of 3 · Songs',
  'очередь.шаг1.текст': 'Pick <b>one or several</b> audio files — mp3, wav, ogg, m4a. In the file dialog they are picked together with <b>Cmd</b> (<b>Ctrl</b> on Windows) or <b>Shift</b>; “Select all” is <b>Cmd+A</b>.',
  'очередь.шаг2.заголовок': 'Step 2 of 3 · Lyrics (optional)',
  'очередь.шаг2.текст': '<b>Lyrics are matched by file name.</b> Next to <b>Leningrad — Luna.mp3</b> there has to be <b>Leningrad — Luna.txt</b>: the name before the dot matches, upper and lower case do not matter. The <b>.txt</b> extension means plain lyrics (the network will place the timings), <b>.lrc</b> means lyrics that already carry them.<br>No lyrics? No problem: the song still gets its instrumental, and you can paste the words later.',
  'очередь.шаг3.заголовок': 'Step 3 of 3 · Where to put the results',
  'очередь.шаг3.текст': 'Every song becomes its own project folder named after the song. <b>Careful:</b> if such a project is already in that folder, it will be replaced.',
  'очередь.выбратьПесни': 'Pick the songs…',
  'очередь.выбратьТексты': 'Pick the lyrics…',
  'очередь.безТекстов': 'No lyrics',
  'очередь.выбратьПапку': 'Pick the folder…',
  ...
  'экспорт.подсказка': 'You can minimise this window — the build carries on in the background. Just do not close the studio before it finishes.',
  ...
  'ред.клавиши': '<kbd>space</kbd> play · <kbd>↑</kbd><kbd>↓</kbd> line · <kbd>←</kbd><kbd>→</kbd> start · <kbd>[</kbd><kbd>]</kbd> end · <kbd>I</kbd><kbd>O</kbd> start and end at the playhead · <kbd>,</kbd><kbd>.</kbd> nudge a frame, with <kbd>Shift</kbd> ten · <kbd>Shift</kbd> finer, <kbd>Alt</kbd> coarser · <kbd>Enter</kbd> listen · <kbd>F2</kbd> edit the line’s text · <kbd>L</kbd> loop · <kbd>S</kbd> snapping · <kbd>G</kbd> beat grid · <kbd>Delete</kbd> remove a stretch · <kbd><span class="mod-key">Cmd</span>+Z</kbd> undo · word joint: a plain drag makes a pause, with <kbd><span class="mod-key">Cmd</span></kbd> both edges move · wheel scrolls, with <kbd><span class="mod-key">Cmd</span></kbd> zooms',
  ...
  'ред.появление.подсказка': 'How long the original takes to reach its level at the start of the stretch. Double-click brings back 0.05 s. It never lasts longer than half the stretch',
  'ред.затухание.подсказка': 'How long the original takes to fade out at the end of the stretch. Double-click brings back 0.05 s. It never lasts longer than half the stretch',
...
I18N.СТРОКИ = {
  ...
  /* Имя студии, а не слово «караоке»: файл уходит на люди — в чат,
     в облако, на видеосервис, — и по имени должно быть видно, чем
     он сделан. Пишется одинаково на обоих языках: это название,
     а не слово для перевода. */
  'экспорт.имяВидео': { ru: '{имя} (karaoke punch).{ext}', en: '{имя} (karaoke punch).{ext}' },
  'экспорт.нетПесни': {
  ...
  'ред.инсп.появление': { ru: 'появление', en: 'fade in' },
  'ред.инсп.затухание': { ru: 'затухание', en: 'fade out' },
  ...
  /* Число пропущенных выпусков говорит громче, чем «вышла новая
     версия»: одну версию человек откладывает не думая, а «отстал
     на семь выпусков» заставляет остановиться. */
  'обновление.отставание': {
    ru: { one: 'Вышла версия {v} — ты отстал на {n} выпуск',
      few: 'Вышла версия {v} — ты отстал на {n} выпуска',
      many: 'Вышла версия {v} — ты отстал на {n} выпусков',
      other: 'Вышла версия {v} — ты отстал на {n} выпусков' },
    en: { one: 'Version {v} is out — you are {n} release behind',
      other: 'Version {v} is out — you are {n} releases behind' },
  },
  ...
  'очередь.ничьиТексты': {
    ru: {
      one: 'Текст «{имена}» не подошёл ни к одной песне: имя файла должно совпадать с именем песни.',
      few: 'Тексты не подошли ни к одной песне ({имена}): имя файла должно совпадать с именем песни.',
      many: 'Тексты не подошли ни к одной песне ({имена}): имя файла должно совпадать с именем песни.',
    },
    en: {
      one: 'The lyrics file “{имена}” did not match any song: the file name has to match the song’s.',
      other: 'These lyrics files matched no song ({имена}): the file name has to match the song’s.',
    },
  },
  'очередь.нетПесен': {
  ...
  /* Три сообщения разметки нейросетью. Их зовёт desktop.js, а в словаре
     их не было вовсе: по-русски человек видел вместо текста сам ключ
     («asr.неПослушалось»), и это нашла быстрая проверка ключей
     (test/project.test.js), а не глаз. */
  'asr.неПослушалось': {
    ru: 'Не получилось расслышать песню: ',
    en: 'Could not make out the song: ',
  },
  'asr.раскладываем': {
    ru: 'Раскладываем текст по песне…',
    en: 'Laying the lyrics onto the song…',
  },
  'asr.неПодогналось': {
    ru: 'Не получилось разложить текст по песне: {ошибка}',
    en: 'Could not lay the lyrics onto the song: {ошибка}',
  },
  'asr.меткаВремена': {
